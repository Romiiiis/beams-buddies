      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflowY: 'auto' }}>
        ...
        >
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(4, minmax(0,1fr))', gap: '10px' }}>
            {[
              { label: 'Draft', value: counts.draft, sub: 'not sent yet', accent: '#9CA3AF', valColor: '#555' },
              { label: 'Sent', value: counts.sent, sub: 'awaiting response', accent: '#1E3A8A', valColor: '#1E3A8A' },
              { label: 'Accepted', value: counts.accepted, sub: 'approved quotes', accent: TEAL, valColor: '#064E3B' },
          ...
          <div style={{ background: '#fff', border: `1px solid ${BORDER}`, borderRadius: '12px', overflow: 'hidden' }}>
            ...
            >
              <span style={{ fontSize: '14px', fontWeight: '600', color: TEXT }}>Quote list</span>
            ...
            {loading ? (
              ...
              <div>
                {filtered.map(q => {
                  ...
                  return (
                    <div key={q.id} style={{ padding: '14px 16px', borderBottom: `1px solid ${BORDER}` }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px', marginBottom: '8px' }}>
                        ...
                        <div style={{ textAlign: 'right', flexShrink: 0 }}>
                          <div style={{ fontSize: '16px', fontWeight: '700', color: TEXT, lineHeight: 1.1 }}>${q.total.toFixed(2)}</div>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'center' }}>
                        <div style={{ fontSize: '11px', color: TEXT3 }}>
                          Valid until{' '}
                          {q.valid_until
                            ? new Date(q.valid_until).toLocaleDateString('en-AU', { day: 'numeric', month: 'short', year: 'numeric' })
                            : '—'}
                        </div>
                        <div style={{ fontSize: '11px', color: TEXT3 }}>
                  ...
                  {filtered.map(q => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '13px 22px' }}>
                          <div style={{ fontSize: '14px', fontWeight: '600', color: TEXT }}>${q.total.toFixed(2)}</div>
                        </td>
      ...
      {showForm && (
        ...
        >
          ...
          >
            ...
            >
              <div>
                <div style={{ fontSize: '14px', fontWeight: '600', color: TEXT }}>New quote</div>
