            ...
            >
              ...
              <div style={panelCard}>
                ...
                <div style={{ display: 'grid', gap: '8px' }}>
                  ...
                  >
                    <div style={{ ...TYPE.label, marginBottom: '5px' }}>Subtotal</div>
                  ...
                  >
                    <div style={{ ...TYPE.label, marginBottom: '5px' }}>GST</div>
                  ...
                  >
                    ...
                    <div style={{ ...TYPE.valueSm }}>${previewTotals.total.toFixed(2)}</div>
                  </div>
                </div>
              </div>
            </div>
