      ...
      <div style={{ borderRadius: '14px', background: 'linear-gradient(180deg,#FFFFFF 0%,#FAFBFC 100%)', border: `1px solid ${BORDER}`, padding: '16px 16px 12px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '28px 1fr', gap: '8px', alignItems: 'stretch' }}>
          ...
          <div style={{ position: 'relative' }}>
            {[0, 50, 100].map((pct, i) => (
              <div key={i} style={{ position: 'absolute', left: 0, right: 0, top: `${pct}%`, borderTop: `1px ${i === 2 ? 'solid' : 'dashed'} #E8EDF3`, zIndex: 0 }} />
            ))}
...
export default function DashboardPage() {
  ...
  const quickBtn: React.CSSProperties = { border: `1px solid ${BORDER}`, background: WHITE, color: TEXT2, borderRadius: '10px', height: '38px', padding: '0 14px', fontSize: '12px', fontWeight: 700, cursor: 'pointer', fontFamily: FONT, display: 'inline-flex', alignItems: 'center', gap: '8px', whiteSpace: 'nowrap' as const, flexShrink: 0 }
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', fontFamily: FONT, background: BG, overflow: 'hidden' }}>
      ...
      {/* Single scroll container — fixes the double-scroll bug */}
      <div style={{ flex: 1, minWidth: 0, overflowY: 'auto', overflowX: 'hidden', background: BG, WebkitOverflowScrolling: 'touch' as any }}>
        <div style={{ display: 'flex', flexDirection: 'column', padding: isMobile ? '14px' : '16px', gap: '12px', paddingBottom: '48px' }}>
          ...
          <div style={{ ...shellCard, padding: isMobile ? '18px 16px 16px' : '22px 24px 20px', background: HEADER_BG, border: '1px solid rgba(255,255,255,0.08)' }}>
            ...
            <div style={{ fontSize: '14px', fontWeight: 500, lineHeight: 1.5, color: 'rgba(255,255,255,0.72)', maxWidth: '760px' }}>
              Track customers, service due dates, invoices, and jobs from one premium control centre.
            </div>
            {/* Buttons always in a row — scroll horizontally on mobile */}
            <div style={{ marginTop: '14px', display: 'flex', flexDirection: 'row', gap: '8px', overflowX: 'auto', paddingBottom: '2px', WebkitOverflowScrolling: 'touch' as any }}>
              <button onClick={() => router.push('/dashboard/jobs')} style={{ ...quickBtn, background: TEAL, color: WHITE, border: 'none', boxShadow: '0 6px 14px rgba(31,158,148,0.20)' }}>
                <IconSpark size={16} /> Add job
              </button>
              <button onClick={() => router.push('/dashboard/quotes')} style={{ ...quickBtn, background: 'rgba(255,255,255,0.06)', color: WHITE, border: '1px solid rgba(255,255,255,0.10)', boxShadow: 'none' }}>
                <IconInvoice size={16} /> New quote
              </button>
              <button onClick={() => router.push('/dashboard/schedule')} style={{ ...quickBtn, background: 'rgba(255,255,255,0.06)', color: WHITE, border: '1px solid rgba(255,255,255,0.10)', boxShadow: 'none' }}>
