...
export default function DashboardPage() {
  ...
  const btnDark: React.CSSProperties = { height: '34px', padding: '0 16px', border: 'none', borderRadius: '9px', fontSize: '12px', fontWeight: 700, color: WHITE, background: TEAL, cursor: 'pointer', fontFamily: FONT, display: 'inline-flex', alignItems: 'center', gap: '6px', whiteSpace: 'nowrap' as const }
  ...
  const btnMobileDark: React.CSSProperties = { ...btnMobileSm, background: TEAL, border: 'none', color: WHITE }
