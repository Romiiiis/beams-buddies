...
function IconInvoice({ size = 15 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
        d="M7 3h10a2 2 0 0 1 2 2v16l-2.5-1.5L14 21l-2.5-1.5L9 21l-2.5-1.5L4 21V5a2 2 0 0 1 2-2Z"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinejoin="round"
      />
...
function IconPhone({ size = 13 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
        d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.4 19.4 0 0 1-6-6 19.8 19.8 0 0 1-3-8.7A2 2 0 0 1 4.2 2h3a2 2 0 0 1 2 1.7l.5 3a2 2 0 0 1-.6 1.8L7.8 9.8a16 16 0 0 0 6.4 6.4l1.3-1.3a2 2 0 0 1 1.8-.6l3 .5A2 2 0 0 1 22 16.9Z"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinejoin="round"
      />
...
function IconUsers({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
      <circle cx="9" cy="7" r="4" stroke="currentColor" strokeWidth="1.9" />
      <path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    </svg>
  )
}
...
function IconBriefcase({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <rect x="2" y="7" width="20" height="14" rx="2" stroke="currentColor" strokeWidth="1.9" />
      <path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2M12 12v4M10 14h4" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    </svg>
  )
}
...
function IconDollar({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    </svg>
  )
}
...
function IconPercent({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M19 5L5 19M9 6.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0ZM20 17.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
    </svg>
  )
}
...
function IconDownload({ size = 13 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
function AnalyticsBarChart({
  ...
  data: { label: string; total: number; revenue?: number }[]
  height?: number
}) {
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        boxShadow: isCurrent ? `0 6px 18px ${TEAL}33` : 'none',
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: '88px repeat(7, 1fr)', gap: '6px', alignItems: 'center' }}>
        <div />
        {days.map((d) => (
          <div key={d} style={{ fontSize: '10px', fontWeight: 700, color: TEXT3, textAlign: 'center' }}>
            {d}
          </div>
        ))}
              ...
              return (
                <div
                  ...
                  style={{
                    height: 26,
                    borderRadius: 20,
                    background: intensity > 0 ? `rgba(31,158,148,${0.15 + intensity * 0.75})` : '#F1F5F9',
...
export default function DashboardPage() {
  ...
  const scheduledCount = useMemo(
    () => allJobs.filter((j) => j.next_service_date && getDays(j.next_service_date) >= 0).length,
    [allJobs],
  )
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: stats.units > 0 ? `${Math.max(1, Math.round((completedCount / Math.max(stats.units, 1)) * 100))}%` : '0%',
            ...
            {statCards.map((sc) => (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '10px' }}>
                  <div>
                    <div style={{ fontSize: '24px', fontWeight: 900, color: TEXT, letterSpacing: '-0.04em', lineHeight: 1 }}>
                      {sc.value}
                    </div>
                  ...
                  return (
                    <div style={{ position: 'relative', width: size, height: 110 }}>
                      <svg width={size} height={110} viewBox={`0 0 ${size} 110`} style={{ overflow: 'visible' }}>
                        <path
                          d={`M ${size / 2 - r} 104 A ${r} ${r} 0 0 1 ${size / 2 + r} 104`}
                          fill="none"
                          stroke="#F1F5F9"
                          strokeWidth={18}
                          strokeLinecap="round"
                      ...
                      >
                        <div style={{ fontSize: '42px', fontWeight: 900, color: TEXT, letterSpacing: '-0.05em', lineHeight: 1 }}>
                          {score}
                        </div>
            ...
            <div style={card}>
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                  ...
                  >
                    {['Last Year', 'This Year', 'Last 6 Months', 'Last 3 Months'].map((o) => (
              ...
              <div style={{ display: 'flex', gap: '20px', padding: '10px 20px 0', borderBottom: `1px solid ${BORDER}` }}>
                {[
                  ...
                  {
                    label: 'Conv. Rate',
                    value: stats.units > 0 ? `${Math.round((completedCount / stats.units) * 100)}%` : '0%',
                  },
                ].map((item) => (
                  ...
                  recent.map((job, i) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          display: 'grid',
                          gridTemplateColumns: isMobile ? 'auto 1fr auto' : 'auto 1fr 120px auto',
                          gap: '12px',
                          alignItems: 'center',
                          padding: '10px 20px',
                          borderBottom: `1px solid ${BORDER}`,
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '10px', color: TEXT3, display: 'flex', alignItems: 'center', gap: '4px', flexWrap: 'wrap' }}>
                ...
                <div style={{ padding: '10px 16px', borderBottom: `1px solid ${BORDER}`, display: 'flex', alignItems: 'baseline', gap: '8px' }}>
                  <span
                    style={{
                      fontSize: '20px',
                      fontWeight: 900,
                      color: invoiceStats.outstanding > 0 ? '#991B1B' : TEXT,
                      letterSpacing: '-0.04em',
                    }}
                  >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ textAlign: 'right' }}>
                          <div style={{ fontSize: '12px', fontWeight: 800, color: isOverdue ? '#991B1B' : TEXT }}>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          borderBottom: `1px solid ${BORDER}`,
                          cursor: 'pointer',
                          background: isFirst ? TEAL_LIGHT : WHITE,
                          transition: 'background 0.12s',
                        }}
                        onMouseEnter={(e) => {
                          if (!isFirst) e.currentTarget.style.background = '#F8FAFC'
                        }}
                        onMouseLeave={(e) => {
                          if (!isFirst) e.currentTarget.style.background = WHITE
                        }}
                      >
                        ...
                        <div style={{ fontSize: '10px', fontWeight: 600, color: isFirst ? TEAL_DARK : TEXT3 }}>
              ...
              {[
                ...
                <div key={item.label} style={{ ...card, padding: '16px 18px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                    ...
                    <span style={{ fontSize: '10px', color: TEXT3, fontWeight: 700 }}>{item.label}</span>
                  </div>
                  <div style={{ fontSize: '24px', fontWeight: 900, color: TEXT, letterSpacing: '-0.04em' }}>{item.value}</div>
                </div>
              ))}
            </div>
          )}
