          ...
          >
            ...
            <div
              style={{
                ...
                background: isCurrent ? TEAL : isHov ? '#CBD5E1' : '#E2E8F0',
            ...
            <span style={{ fontSize: '8px', fontWeight: 700, color: isCurrent ? TEAL_DARK : TEXT3 }}>
              {item.label}
            </span>
          </div>
        )
  ...
  useEffect(() => {
    async function load() {
      ...
      const overdue = jobs.filter(j => {
        ...
        return startOfDay(new Date(j.next_service_date)) < today
      })
      ...
      const jobsToday = jobs.filter(j => {
        if (!j.next_service_date) return false
        const d = startOfDay(new Date(j.next_service_date))
            ...
            <div style={cardP}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginTop: '14px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
                  ...
                  <span style={{ fontSize: '11px', fontWeight: 600, color: TEXT2, flex: 1 }}>Jobs today</span>
                  <span style={{ fontSize: '11px', fontWeight: 700, color: TEXT }}>{stats.jobsToday}</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
                  <span style={{ width: 8, height: 8, borderRadius: '50%', background: TEAL_DARK, flexShrink: 0 }} />
                  <span style={{ fontSize: '11px', fontWeight: 600, color: TEXT2, flex: 1 }}>Scheduled jobs</span>
                  <span style={{ fontSize: '11px', fontWeight: 700, color: TEXT }}>{scheduledCount}</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
                  <span style={{ width: 8, height: 8, borderRadius: '50%', background: '#94A3B8', flexShrink: 0 }} />
                  <span style={{ fontSize: '11px', fontWeight: 600, color: TEXT2, flex: 1 }}>Units tracked</span>
                  <span style={{ fontSize: '11px', fontWeight: 700, color: TEXT }}>{stats.units}</span>
                </div>
              </div>
            ...
            <div style={card}>
              <div style={{ padding: '16px 18px 12px', borderBottom: `1px solid ${BORDER}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                  {[
                    { label: 'Today', val: todayAppointmentsCount },
              ...
              {upcoming.length === 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    {!isMobile && (
                      <div style={{ fontSize: '11px', fontWeight: 600, color: TEXT3, whiteSpace: 'nowrap' }}>
              ...
              {recent.length === 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ padding: '4px 9px', borderRadius: '999px', background: sp.bg, color: sp.color, fontSize: '10px', fontWeight: 800, whiteSpace: 'nowrap' }}>
                      {sp.label}
                    </span>
                  </div>
                )
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right', flexShrink: 0 }}>
                      <div style={{ fontSize: '13px', fontWeight: 800, color: isOverdue ? '#991B1B' : TEXT }}>
