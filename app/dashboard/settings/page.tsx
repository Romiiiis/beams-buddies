      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflowY: 'auto' }}>
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: isMobile ? '26px' : '30px', fontWeight: '700', color: TEXT, letterSpacing: '-0.6px', lineHeight: 1 }}>Settings</div>
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            {saved && <span style={{ fontSize: '13px', color: '#065F46', fontWeight: '600' }}>✓ Saved</span>}
            <button
              form="settings-form"
              type="submit"
          ...
          {loading ? (
            ...
            <form id="settings-form" onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={section}>
                <div style={sHead}>
                  <div>
                    <div style={{ fontSize: '14px', fontWeight: '600', color: TEXT }}>Your profile</div>
                    <div style={{ fontSize: '12px', color: TEXT3, marginTop: '2px' }}>Personal details shown in your workspace</div>
                  </div>
                </div>
              ...
              <div style={section}>
                <div style={sHead}>
                  <div>
                    <div style={{ fontSize: '14px', fontWeight: '600', color: TEXT }}>Business profile</div>
                    <div style={{ fontSize: '12px', color: TEXT3, marginTop: '2px' }}>Core business details and branding</div>
                  </div>
                </div>
                  ...
                  <div style={{ background: '#fff', border: `1px solid ${BORDER}`, borderRadius: '12px', overflow: 'hidden' }}>
                    ...
                    <div style={{
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: '13px', fontWeight: '600', color: TEXT, marginBottom: '4px' }}>
                          Business logo
                        </div>
              ...
              <div style={section}>
                <div style={sHead}>
                  <div>
                    <div style={{ fontSize: '14px', fontWeight: '600', color: TEXT }}>Review platforms</div>
                    <div style={{ fontSize: '12px', color: TEXT3, marginTop: '2px' }}>Manage review destinations for customers</div>
                  </div>
                </div>
                ...
                <div style={sBody}>
                  ...
                  >
                    <span style={{ fontSize: '16px', color: A }}>+</span>
              ...
              <div style={section}>
                <div style={sHead}>
                  <div>
                    <div style={{ fontSize: '14px', fontWeight: '600', color: TEXT }}>Review discount</div>
                    <div style={{ fontSize: '12px', color: TEXT3, marginTop: '2px' }}>Control the offer shown after installation</div>
                  </div>
                </div>
                  ...
                  <div style={{
                    ...
                    <div
                      ...
                      style={{
                        ...
                        height: '24px',
                        borderRadius: '12px',
                        background: form.review_discount_enabled ? A : '#D1D5DB',
                        cursor: 'pointer',
                        position: 'relative',
                        flexShrink: 0
                      }}
                    ...
                    <>
                      <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '14px' }}>
                        <div>
                          ...
                          <input
                            ...
                            min="1"
                            style={input}
                            value={form.review_discount_amount}
                            onChange={e => set('review_discount_amount', e.target.value)}
                            placeholder="10"
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            min="1"
                            style={input}
                            value={form.review_discount_max}
                            onChange={e => set('review_discount_max', e.target.value)}
                            placeholder="30"
                          />
                      ...
                      <div style={{ background: '#fff', border: `1px solid ${BORDER}`, borderRadius: '12px', overflow: 'hidden' }}>
                        ...
                        <div style={{ padding: '16px 18px' }}>
                          <div style={{ fontSize: '13px', fontWeight: '600', color: '#0A4F4C', marginBottom: '6px' }}>
