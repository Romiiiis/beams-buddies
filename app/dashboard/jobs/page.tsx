        ...
        <div style={{ height: '58px', background: '#fff', borderBottom: `1px solid ${BORDER}`, padding: `0 ${pad}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              ...
              style={{ height: '36px', padding: '0 14px', borderRadius: '8px', border: `1px solid ${BORDER}`, background: '#fff', color: TEXT2, fontSize: '14px', cursor: 'pointer', fontFamily: 'inherit' }}
            >
              Cancel
            </button>
            <button
              ...
              type="submit"
              disabled={loading}
              style={{ height: '36px', padding: '0 14px', borderRadius: '8px', border: 'none', background: A, color: '#fff', fontSize: '14px', fontWeight: '500', cursor: 'pointer', fontFamily: 'inherit' }}
            >
          ...
          <form id="job-form" onSubmit={handleSubmit}>
            ...
            <div style={section}>
              ...
              <div style={{ padding: '16px 22px', display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '14px' }}>
                ...
                <div style={{ gridColumn: isMobile ? '1' : 'span 2' }}><label style={label}>Address</label><input style={input} value={form.address} onChange={e => set('address', e.target.value)} placeholder="14 Blackwood St" /></div>
