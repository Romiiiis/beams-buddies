...
// Skeleton shimmer for the sidebar bottom user section
  ...
  return (
    <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '11px' }}>
          ...
          <div>
            ...
            {loading ? (
              ...
              <div style={{ fontSize: '12px', color: TEXT3, marginTop: '1px' }}>
                {business?.name || ''}
              </div>
            )}
          </div>
      ...
      <div style={{ padding: '12px 10px', flex: 1 }}>
        <div style={{
          fontSize: '11px', fontWeight: '600', color: TEXT3,
          ...
          return (
            <div
              ...
              style={{
                ...
                background: isActive ? '#CCEFED' : 'transparent',
                marginBottom: '2px',
              }}
              onMouseEnter={e => { if (!isActive) e.currentTarget.style.background = '#F0F0F0' }}
              onMouseLeave={e => { if (!isActive) e.currentTarget.style.background = 'transparent' }}
            >
              <span style={{ color: isActive ? A : TEXT3, display: 'flex', flexShrink: 0 }}>
                {icons[item.href]}
              </span>
              {item.label}
            </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            {business?.logo_url ? (
              <img
                ...
                style={{ width: '30px', height: '30px', borderRadius: '50%', objectFit: 'contain', background: '#fff', padding: '2px', flexShrink: 0 }}
              />
            ) : (
              <div style={{
                width: '30px', height: '30px', borderRadius: '50%',
                background: '#CCEFED', color: '#0A4F4C',
